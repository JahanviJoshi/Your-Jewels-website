...
{
    public partial class Mdviewdetails : System.Web.UI.Page
    {
        ...
        void bind()
        {
            ...
            SqlCommand cmd = new SqlCommand("Select * from dpendant where Pendantid= '" + abc+"'", con);
        ...
        protected void DataList1_ItemCommand1(object source, DataListCommandEventArgs e)
        {
            ...
            if (e.CommandName == "addtocart")
            {
                ...
                Response.Redirect("MAddToCart?id=" + e.CommandArgument.ToString() + "&Quantity=" + dlist.SelectedItem.ToString());
