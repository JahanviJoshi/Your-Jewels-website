...
{
    public partial class bu2 : System.Web.UI.Page
    {
        ...
        {
            string mycon = "Data Source=DESKTOP-M40PQKC; Initial Catalog=database; Integrated Security=true";
            string updatedata = "delete from bracelets where Braceletid=" + TextBox5.Text;
            SqlConnection con = new SqlConnection(mycon);
            con.Open();
            SqlCommand cmd = new SqlCommand();
            ...
            cmd.ExecuteNonQuery();
            Label5.Text = "";
            Label3.Text = "Record Has Been Deleted Successfully with Braceletid:" + TextBox5.Text;
            TextBox1.Text = "";
            TextBox2.Text = "";
            TextBox3.Text = "";
            TextBox4.Text = "";
