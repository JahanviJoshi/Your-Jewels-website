<%@ Page Title="" Language="C#" MasterPageFile="~/mhome.Master" AutoEventWireup="true" CodeBehind="Successfully.aspx.cs" Inherits="user_Registration.PlacedOrder" %>
        ...
        &nbsp;<table border="1" class="auto-style1">
            ...
            <tr>
                <td class="auto-style12">
                    <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Height="140px" Width="936px" OnSelectedIndexChanged="GridView1_SelectedIndexChanged" >
                        <Columns>
