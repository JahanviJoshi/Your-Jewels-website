...
{
    public partial class Mviewdetails3 : System.Web.UI.Page
    {
        ...
        void bind()
        {
            ...
            SqlCommand cmd = new SqlCommand("Select * from bracelets where Braceletid=" + abc, con);
        ...
        protected void DataList1_ItemCommand(object source, DataListCommandEventArgs e)
        {
            ...
            Response.Redirect("MAddToCart.aspx?id=" + e.CommandArgument.ToString() + "&Quantity=" + dlist.SelectedIndex.ToString());
